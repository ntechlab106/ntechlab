    ...
    */
    Preloader: function() {
        $(window).load(function() {
            $('#status').delay(10).fadeOut('slow');
            $('#preloader').delay(10).fadeOut('slow');
            $('body').delay(10).css({'overflow':'visible'});
            setTimeout(function(){$('#logo').addClass('animated fadeInDown')},200);
            setTimeout(function(){$('#logo_header').addClass('animated fadeInDown')},300);
            setTimeout(function(){$('#slogan').addClass('animated fadeInDown')},400);
            setTimeout(function(){$('#slogan-second').addClass('animated fadeInDown')},500);
            setTimeout(function(){$('#home_image').addClass('animated fadeInUp')},600);
        })
    },
    ...
    */
    Animations: function() {
        ...
        $('#features_3').waypoint(function() {
            ...
            setTimeout(function(){$('#features_3_content_center').addClass('animated fadeInDown')},200)
        }, { offset: '50%' });

		$('#team').waypoint(function() {
			setTimeout(function(){$('#team-members').addClass('animated fadeInDown')},200)
        }, { offset: '50%' });

        $('#portfolio').waypoint(function() {
            setTimeout(function(){$('#portfolio-item').addClass('animated fadeInDown')},200)
        }, { offset: '50%' });

        $('#contact').waypoint(function() {
            setTimeout(function(){$('#contact-header').addClass('animated fadeInDown')},100)
            setTimeout(function(){$('#contact-info').addClass('animated fadeInDown')},200)
        }, { offset: '50%' });
